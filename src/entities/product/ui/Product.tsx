...
export default function Product({ product }: ProductProps) {
  ...
  const isCart = useAppSelector((state) => isInCart(state, product))
  ...
  return (
    <div data-testid="product-wrapper" className={`bg-white flex-1 min-w-[150px] max-w-[180px] p-2.5 flex flex-col gap-2.5 rounded-[30px] ${isCurrent() ? 'outline outline-green-500 ' : ''}`} style={{ boxShadow: '-1px -5px 61px rgba(139, 138, 138, 0.12)' }}>
      ...
      <div className="touch-manipulation" onClick={selectProduct}>
        ...
        <div className="flex justify-between items-center mt-[7px]">
          ...
          <IconButton variant={isCart ? 'warning' : 'success'} size="medium" onClick={(e) => toggleProductInCart(e)} sx={{ touchAction: 'manipulation' }}>
