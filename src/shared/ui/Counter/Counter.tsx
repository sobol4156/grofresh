...
export default function Counter({ product, handleChange }: CounterProps) {

  return (
    <div className="flex items-center gap-2.5">
      <IconButton onClick={() => handleChange('decrease')} sx={{touchAction: 'manipulation'}}>
      ...
      <span className="large-bold">{product.quantity}</span>

      <IconButton onClick={() => handleChange('increment')} sx={{touchAction: 'manipulation'}}>
        <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
